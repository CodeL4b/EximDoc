      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('consigneedetail') }}"><i class="fa fa-user"></i> Consignee Detail</a></li>
            <li><a href="{{ url('bankdetail') }}"><i class="fa fa-bank"></i> Master Detail</a></li>
            <li><a href="{{ url('productdetail') }}"><i class="fa fa-shopping-cart"></i> Product Detail</a></li>
            <li><a href="{{ url('currency') }}"><i class="fa fa-money"></i>Currency</a></li>
          </ul>
        </li>
        <li>
          <a href="{{ url('proformainvoice') }}">
            <i class="fa fa-file-text-o"></i> <span>Proforma Invoice</span>
          </a>
        </li>
        <li>
          <a href="{{ url('paymentreceiptentry') }}">
            <i class="fa fa-money"></i> <span>Payment Receipt Entry</span>
          </a>
        </li>
        <li>
          <a href="{{ url('generatedoc') }}">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('billexchange') }}"><i class="fa fa-exchange"></i> Bill of Exchange</a></li>
            <li><a href="{{ url('bankcollectionletter') }}"><i class="fa fa-envelope"></i> Bill Collection Letter</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('changepassword') }}"><i class="fa fa-shield"></i> Change Password</a></li>
          </ul>
        </li>
        <li>
