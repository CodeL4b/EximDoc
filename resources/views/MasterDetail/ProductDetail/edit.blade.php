        ...
        <div class="col-md-12">
          <!-- general form elements -->
			<div class="box box-primary">
				...
				<form id="product_frm" action="{{route('productdetail.update', $productdetail->id)}}" method="post" enctype="multipart/form-data">
					<div class="box-body">
						@csrf
						@method('PUT')
						<div class="form-group">
							<label for="exampleInputEmail1">Product Name <i style="color:red;font-size:15px;">*</i> :-</label>
							<input type="text" spellcheck="false" name="product_name"  class="validate[required] form-control" id="product_name" value="{{$productdetail->product_name}}"  placeholder="Name" autofocus/>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="product_HS"  class="validate[required,custom[integer]] form-control" id="product_HS" value="{{$productdetail->product_HS}}"  placeholder="HS Code" />
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-4 col-xs-12 form-group">
								...
								<input type="text" name="product_price"  class="form-control" id="product_price" value="{{$productdetail->product_price}}" placeholder="Product Price" />
							</div>
							
							<div class="col-xs-4 col-xs-12 form-group">
								<label for="exampleInputEmail1" >Unit :-</label>
								<input type="text" name="per_price"  class="form-control" id="per_price" value="{{$productdetail->per_price}}" placeholder="kg." />
							</div>
