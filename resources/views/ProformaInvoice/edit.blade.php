        ...
        <div class="col-md-12">
			<div class="nav-tabs-custom">
				...
				<form id="proforma_frm" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" name="proforma_sr_no" value="3">
						...
						<div class="row">	
							...
							<div class="col-md-5 col-xs-12 form-group">
								...
								<select  name="consignee_id" id="consignee_id" onchange="fetch_consignee(this);" class="validate[required] form-control search_test" >
									<option id="none" value="">-- Select Consignee --</option>
														
									<option value="add_consignee">Add New</option>
								</select> 
							</div>
					...
					<br>
					<div id="err_msg" class="alert proforma_success alert-success alert-dismissable">
					</div>
				</form>
