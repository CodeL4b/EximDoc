        ...
        <div class="col-md-12">
          <!-- general form elements -->
			<div class="box box-primary">
				...
				<form id="product_frm" action="<?php echo e(route('productdetail.store')); ?>" method="post" enctype="multipart/form-data">
					<div class="box-body">
						<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Admin\EximDoc\resources\views/MasterDetail/ProductDetail/create.blade.php ENDPATH**/ ?>