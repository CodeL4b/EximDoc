			...
			<div class="nav-tabs-custom">
				...
				<form id="proforma_frm" method="post" enctype="multipart/form-data">
							...
							<div class="col-md-5 col-xs-12 form-group">
								...
								<select name="consignee_id" id="consignee_id"  class="validate[required] form-control search_test" >
										...
										<?php $__currentLoopData = $consigneedetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consigneedetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option><?php echo e($consigneedetail-> consignee_name); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<option href="<?php echo e(route('consigneedetail.create')); ?>" value="add_consignee" >Add New</option>
								</select>
							</div>
							...
							<div class="col-md-4 col-xs-12 form-group">
								...
								<select  name="bank_id" id="bank_id" class="validate[required] form-control search_test" >
									...
									<?php $__currentLoopData = $bankdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option><?php echo e($bankdetail-> bank_name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
							<div class="col-md-4 col-xs-12 form-group">
								...
								<select  name="currency_code" id="currency_code" class="validate[required] form-control search_test" >
									...
									<?php $__currentLoopData = $currencys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option><?php echo e($currency-> currency_code); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="box-footer">
						...
						<a href="<?php echo e(route('proformainvoice.index')); ?>" class="btn btn-success">Cancel</a>
					</div>
				</form>		
			</div>
		</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Github\EximDoc\resources\views/ProformaInvoice/create.blade.php ENDPATH**/ ?>